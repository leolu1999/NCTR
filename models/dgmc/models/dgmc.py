...
class DGMC(torch.nn.Module):
    ...
    """
    def __init__(self, psi_2, num_steps, k=-1, detach=False):
    ...
    def forward(self, h_s, edge_index_s, edge_attr_s, batch_s, h_t,
        ...
        """
        # for parameters in self.mlp.parameters():
        #     print(parameters)
        #     print('mlp')
        ...
        mlpd = self.mlp(D.mean(dim=2)).transpose(1, 2)
        return mlpd
    ...
    def __repr__(self):
        return ('{}(\n'
                '    psi_2={},\n'
                '    num_steps={}').format(self.__class__.__name__, self.psi_2, self.num_steps)
